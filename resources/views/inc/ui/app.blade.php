        ...
        <div id="main">
            ...
            <div class="main-container">
                ...
                <header class="main-header">
                    ...
                    <a data-src="images/main.jpg" class="image-popup header-popup color-bg"><i class="fal fa-plus"></i></a>
                    <div class="header-titile-img">
                        <div class="bg"  data-bg="images/main.jpg" ></div>
                    </div>
                    <div class="main-menu-wrap">
                        <!-- nav -->
                        <nav class="nav-inner fl-wrap" id="menu">
                            <ul>
                                <li><a href="index.html" class="ajax"><i class="fal fa-home"></i> Home</a></li>
                                <li><a href="resume.html" class="ajax"><i class="fal fa-address-card"></i> Resume</a></li>
                                <li><a href="portfolio.html" class="ajax"><i class="fal fa-images"></i> Portfolio</a></li>
                                <li><a href="contacts.html" class="ajax"><i class="fal fa-envelope"></i> Contacts</a></li>
                                <li><a href="blog.html" class="ajax"><i class="fal fa-book"></i> Blog</a></li>
                                <li>
                    ...
                    <a href="#" download="" class="header_btn gradient-bg"><i class="fas fa-download"></i> Download CV</a>
                </header>
                <!--header end-->
                <!-- top-opt -->
                <div class="top-opt">
                                    ...
                                    <div class="hero-section-title">
                                        <div class="row">
                                            <div class="col-md-7">
												...
												<div class="video_btn-wrap fl-wrap"><a data-src="https://vimeo.com/176916362" class="image-popup gradient-bg"><i class="fas fa-play"></i></a><span>Play  Video Presentation</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </section>
                                        ...
                                        <div class="col-md-5">
                                            <div class="hero-info-list fl-wrap">
                                                <ul>
                                                    ...
                                                    <li><strong>Residence</strong><span>Ukraine</span></li>
                                                    <li><strong>Address</strong><span>Kharkiv</span></li>
                                                    <li><strong>Hobby</strong><span>Footbal , Traveling</span></li>
                                                </ul>
